...
export default function PricingPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-500/10 blur-[150px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-5 py-2 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-sm font-semibold shadow-lg shadow-blue-500/30">
                    Most Popular
                  </div>
                )}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-block mt-10 px-10 py-4 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 font-semibold hover:shadow-lg hover:shadow-blue-500/30 transition"
            >
              Start Your Project 🚀
            </motion.a>
          </motion.div>
