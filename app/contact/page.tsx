...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Success - both Supabase and email sent
  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-hidden">
      ...
      {/* Background Glows */}
      <div className="fixed top-20 left-10 w-96 h-96 bg-blue-600/20 blur-[140px] rounded-full pointer-events-none" />
      <div className="fixed bottom-20 right-10 w-96 h-96 bg-purple-600/20 blur-[140px] rounded-full pointer-events-none" />
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-blue-500/10 blur-[150px] rounded-full pointer-events-none" />
            ...
            <div className="lg:col-span-2 space-y-4">
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  className={`block p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl hover:border-${info.color}-500/50 transition duration-300 group`}
                >
              ...
              <motion.a
                ...
                className="block p-6 rounded-2xl bg-gradient-to-r from-green-500/20 to-green-600/20 border border-green-500/30 backdrop-blur-xl text-center group"
              >
                <div className="flex items-center justify-center gap-3">
                  <span className="text-3xl">💬</span>
                  <div>
                    <h3 className="text-lg font-semibold">Chat on WhatsApp</h3>
                    <p className="text-sm text-gray-400">Quick response within 24 hours</p>
                  </div>
                </div>
              </motion.a>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-5 py-4 rounded-xl bg-black/40 border border-white/10 focus:border-blue-500/50 focus:outline-none transition"
                      />
                    </div>
                    <div>
                      <label className="block text-sm text-gray-400 mb-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-5 py-4 rounded-xl bg-black/40 border border-white/10 focus:border-blue-500/50 focus:outline-none transition text-gray-300"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-5 py-4 rounded-xl bg-black/40 border border-white/10 focus:border-blue-500/50 focus:outline-none transition resize-none"
                    />
                  </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="rounded-3xl p-12 text-center bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 border border-white/10 backdrop-blur-xl"
          >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-block mt-10 px-10 py-4 rounded-xl bg-gradient-to-r from-green-500 to-green-600 font-semibold hover:shadow-lg hover:shadow-green-500/30 transition"
            >
              Chat on WhatsApp 💬
            </motion.a>
          </motion.div>
      ...
      <footer className="border-t border-white/10 py-10 text-center">
        ...
        >
          <h3 className="text-2xl font-bold text-white">Optiwebx</h3>
